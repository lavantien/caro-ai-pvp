...
dotnet build ~/dev/caro-assistantcode/backend/Caro.Api.sln --verbosity quiet

Write-Host "Running 10 Expert vs Expert games..." -ForegroundColor Green
$stopwatch = [System.Diagnostics.Stopwatch]::StartNew()

pushd ~/dev/caro-assistantcode/backend/src/Caro.TournamentRunner/bin/Debug/net10.0
