...
public class ThreatDetectionDiagnosticTests
{
    ...
    public void OpenThree_ShouldBeBlocked_BeforeItBecomesOpenFour()
    {
        ...
        var move = ai.GetBestMove(board, Player.Red, timeRemainingMs: 60000, moveNumber: 1);

        // AI should block at one end of the open three
        var validBlocks = new[] { (10, 7), (10, 11) };
        validBlocks.Should().Contain((move.x, move.y),
            "AI should block the open three at one end before it becomes an open four");
    }
    ...
    public void Grandmaster_ShouldBlockOpenThree_ThenHandleNextThreat()
    {
        ...
        var move1 = ai.GetBestMove(board, Player.Red, timeRemainingMs: 60000, moveNumber: 1);
        ...
        var move2 = ai.GetBestMove(board3, Player.Red, timeRemainingMs: 60000, moveNumber: 3);
